...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <meta name="author" content="Jtech Setiadi">
    ...
    <body>
                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="<?php echo base_url().'admin/dashboard'?>">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">PunyA</span><span class="font-size-xl text-success">cara</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url().'admin/paket'?>"><i class="si si-star"></i><span class="sidebar-mini-hide">Paket</span></a>
                                </li>
                                <li>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Paket</h3>
                                    <div class="block-options">
                                        <a href="<?php echo site_url('admin/paket/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/paket/get_edit/'.$row->kd_compare);?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
            ...
            <footer id="page-footer" class="opacity-0">
                <div class="content py-20 font-size-xs clearfix">
                    <div class="float-right">
                        Created with <i class="fa fa-heart text-pulse"></i> by <a class="font-w600" href="http://jtech.my.id" target="_blank">Jtech Setiadi</a>
                    </div>
                    <div class="float-left">
                        <a class="font-w600" href="https://jtech.my.id" target="_blank">Jtech</a> &copy; <span class="js-year-copy"><?php echo date('Y');?></span>
                    </div>
                </div>
            </footer>
            <!-- END Footer -->
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/paket/hapus_paket'?>" method="post">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus paket ini?</p>
